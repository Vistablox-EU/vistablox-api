...
import { IdentityDisplayProfileProvider } from "../src/infrastructure/profile/kyc-service-display-profile.provider.js";
...
// kyc-internal-api.test.ts already exercises the same service.
