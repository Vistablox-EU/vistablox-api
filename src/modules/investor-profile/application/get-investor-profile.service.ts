...
import type { InvestorProfileRepository } from "../repository/investor-profile.repository.js";

export class GetInvestorProfileService {
  public constructor(
  ...
  public async execute(accountId: string) {
    ...
    return {
      data: {
        ...
        login_methods: profile.loginMethods.map((method) => ({
        ...
        investment_summary: {
          reservation_count: profile.reservationCount,
          active_position_count: profile.activePositionCount,
        },
        readiness: {
          investment_eligible: investmentEligible,
          payment_account_ready: profile.walletRegistration !== null,
          payout_account_verified:
            profile.walletRegistration !== null &&
            profile.walletRegistration.registeredAt !== null,
        },
        wallet: {
          status:
            profile.walletRegistration === null
              ...
              : profile.walletRegistration.registeredAt === null
                ...
                : "registered",
          requested_at:
            profile.walletRegistration?.requestedAt.toISOString() ?? null,
          registered_at:
            profile.walletRegistration?.registeredAt?.toISOString() ?? null,
        },
      },
    };
  }
