...
import type { InvestorActivityQuery } from "../api/investor-activity.schemas.js";
import type {
  InvestorActivityRepository,
  InvestorPositionCursor,
  InvestorReservationCursor,
} from "../repository/investor-activity.repository.js";
...
export class ListInvestorReservationsService {
  public constructor(private readonly repository: InvestorActivityRepository) {}
