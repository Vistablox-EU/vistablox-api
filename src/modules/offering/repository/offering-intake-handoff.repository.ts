...
/**
 * The worker-side half of the intake-to-offering handoff (AD-145):
 * intake approval enqueues the job, this creates the Piv/Offering
 ...
 */
export interface OfferingIntakeHandoffRepository {
